...
<html>
    <head>
        <title>Shaikh Shadab: A Learner</title>
	...
	<div class="container">
		...
		<form role="form" id='form1' method="post" action="">
			<h1> Create Account</h1>
				...
				<fieldset class="form-group">
					...
					<input class="form-control" type="number" maxlenght="10" id="mobile" name="mobile" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required>
				</fieldset>
				<fieldset class="form-group">
		...
		<footer>
			<div>
				&copy;2018 All rights reserved - Shaikh Shadab
			</div>
		</footer>
